...
4. Translate inbound platform events into `MessagingInboundEvent`. Authorize on stable platform user IDs. Use short opaque callback handles persisted in the messaging store with delivery-scoped record IDs.
